...
function printCipherSuites(cs: [cipher_suite]) {
    const ncs = [];
...
function printCertificateRequest(scr) {
	...
	distinguished_names: scr.distinguished_names.map(e => rsasign.X509.hex2dn(
	    e))
    })
}
...
function testKDF() {
	...
	.toLowerCase().replace(/\s/g, "");
    var label = "6b 65 79 20 65 78 70 61 6e 73 69 6f 6e".toLowerCase().replace(
									       /\s/g, "");
    var expected = util.hexStringToByteArray(
					     ""
					     )
